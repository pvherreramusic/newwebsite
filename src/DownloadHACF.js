...
const HACFDownloadFiles = () => {
    const [downloads, setDownloads] = useState([
        {
            id: 1,
            name: 'Her Atmosphere Causes The Fear EP (2011).zip',
            type: 'ZIP',
            size: '45.2 MB',
            url: 'https://pvherreramusicfiles.s3.us-east-1.amazonaws.com/Her+Atmosphere+Causes+the+Fear.zip'
        },
    ]);
    ...
    const loadCount = async () => {
        try {
            const response = await fetch(
                `https://api.api-ninjas.com/v1/counter?id=atomsphere&hit=false
`,
                {
                    headers: {
    ...
    const incrementCounter = async () => {
        try {
            const response = await fetch(
                `https://api.api-ninjas.com/v1/counter?id=atomsphere&hit=true
`,
                {
                    headers: {
                        'X-Api-Key': '71csB5pU5aujUh8AOS3lc1c7a0odMcEqlY0XIapQ'
        ...
        <>
            <div style={containerStyle}>
                <div style={headerStyle}>
                    ...
                    <p style={subtitleStyle}>EP 1 : Her Atmosphere Causes The Fear (2011)</p>
                </div>
...
export default HACFDownloadFiles;